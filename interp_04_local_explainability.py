...
class StartupLocalExplainer:
    ...
    def __init__(self, checkpoint_path, pretrained_path, output_dir="local_explainability_results"):
    ...
    def load_model_and_data(self):
        ...
        try:
            ...
            self.datamodule = SurvivalDataModule(
                ...
                batch_size=8,  # Smaller batch size for attention extraction
                num_workers=1,
...
def main():
    ...
    explainer = StartupLocalExplainer(
        checkpoint_path=checkpoint_path,
        pretrained_path=pretrained_path,
        output_dir="local_explainability_results"
    )
    ...
    batch_choice = input("Enter number of batches (0 for ALL data, 200+ recommended): ").strip()
    try:
    ...
    success = explainer.run_complete_explainability(
    ...
    if success:
        print(f"\n🎉 SUCCESS! Local explainability analysis completed in {end_time-start_time:.1f} seconds")
        print("\n🔍 EXPLANATIONS CREATED:")
        print("  • Token importance analysis with survival correlation")
        print("  • Attention weight heatmaps (if available)")
        print("  • Individual startup explanations")
        print("  • Confidence vs accuracy analysis")
        print("  • Explanation example visualizations")
        print("\n💡 NEXT STEPS:")
        print("  1. Check local_explainability_report.txt for detailed findings")
        print("  2. View explanations/ folder for visualization plots")
        print("  3. Check attention_viz/ folder for attention heatmaps")
        print("  4. Use local_explainability_results.pkl for further analysis")
        print("  5. Run the final script: 05_global_explainability.py")
        return 0
    else:
        print(f"\n❌ Local explainability analysis failed")
        return 1
