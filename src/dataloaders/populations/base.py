...
class Population:
    ...
    def population(self) -> pd.DataFrame:
        """
        Return the population as a pandas dataframe with an index named USER_ID.
        This dataframe will be left joined on the sentences, so any additional columns
        will be included in sentence data of the corpus. Should at least include relevant
        background information for the entities.
        """
