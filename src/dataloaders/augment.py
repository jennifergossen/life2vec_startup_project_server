...
import random
import numpy as np
from .types import StartupDocument


def drop_tokens(document: StartupDocument, p) -> StartupDocument:
...
def align_document(document: StartupDocument) -> StartupDocument:
...
) -> StartupDocument:  # 732 corresponds to time between 01/01/08-01/01/10
...
def add_noise2time(document: StartupDocument) -> StartupDocument:
...
def resample_document(document: StartupDocument) -> StartupDocument:
...
def shuffle_sentences(document: StartupDocument) -> StartupDocument:
